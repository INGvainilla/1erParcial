...
import 'package:fashionstore_mobile/modules/p03_catalogo_estilismo_ia/ar_viewer/widgets/ar_wearable_garment.dart';
import 'package:fashionstore_mobile/modules/p03_catalogo_estilismo_ia/ar_viewer/widgets/garment_ar_painter.dart';
import 'package:fashionstore_mobile/modules/p03_catalogo_estilismo_ia/ar_viewer/widgets/pose_skeleton_painter.dart';
...
class _VestidorArScreenState extends State<VestidorArScreen>
  ...
  bool _showDebugSkeleton = false; // Desactivado por defecto para vista formal sin líneas invasivas
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          // 4. BARRA SUPERIOR FORMAL (ATELIER LUXURY HUD)
          Positioned(
            top: 0,
            left: 0,
            right: 0,
            child: SafeArea(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppTheme.goldColor.withOpacity(0.35), width: 0.8),
                  boxShadow: [
                    BoxShadow(
                        ...
                        onLongPress: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                _showDebugSkeleton
                                    ? 'Modo Diagnóstico: Landmarks y anclajes afines visibles'
                                    : 'Modo Alta Costura: Vista limpia activa',
                              ),
                            ...
                            Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: _trackingState == 0 ? Colors.greenAccent : AppTheme.goldColor,
                                    boxShadow: [
                                      BoxShadow(
                                        color: (_trackingState == 0 ? Colors.greenAccent : AppTheme.goldColor).withOpacity(0.6),
                                        blurRadius: 4,
                                      ),
                                    ],
                                  ),
          ...
          // 5. CÁPSULA LATERAL SUTIL (HERRAMIENTAS BOUTIQUE)
          Positioned(
            right: 16,
            top: 95,
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xDD0D111A),
                borderRadius: BorderRadius.circular(22),
                border: Border.all(color: AppTheme.goldColor.withOpacity(0.25), width: 0.8),
                boxShadow: [
                  BoxShadow(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_cameras.length > 1)
                    IconButton(
                      icon: const Icon(Icons.flip_camera_ios_outlined, color: AppTheme.goldColor, size: 20),
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text('Iluminación: ${_iluminaciones[_modoIluminacion]}'),
                  ...
                  // Re-anclar hombros y escala
                  IconButton(
                    icon: Icon(
                      _modoManualForzado ? Icons.touch_app : Icons.auto_awesome,
                      color: _modoManualForzado ? Colors.amber : Colors.white70,
                      size: 20,
                    ),
                    tooltip: 'Recentrar Prenda al Cuerpo',
                    onPressed: () {
                  ...
                  IconButton(
                    icon: const Icon(Icons.document_scanner_outlined, color: Colors.white70, size: 20),
                    tooltip: 'Reporte de Calce y Hombros',
                    onPressed: () {
                      HapticFeedback.selectionClick();
                      _simularEscaneoBiometrico();
                    },
                  ),
                  // Captura Lookbook
                  IconButton(
                    icon: _capturandoFoto
                        ...
                        : const Icon(Icons.camera_alt_outlined, color: AppTheme.goldColor, size: 20),
                    tooltip: 'Guardar Look en Vestidor',
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Builder(
                        builder: (context) {
                          double precioActual = widget.prenda.precioFinal;
                          try {
                            final tallaObj = widget.prenda.tallas.firstWhere((t) => t.talla == _tallaSeleccionada);
                            if (tallaObj.precio != null && tallaObj.precio! > 0) {
                              precioActual = tallaObj.precio!;
                            }
                          } catch (_) {}
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                                'PRECIO BOUTIQUE',
                                style: TextStyle(color: AppTheme.mutedTextColor, fontSize: 10, letterSpacing: 0.8),
                              ),
                              Text(
