...
from app.modules.p09_procesamiento_pagos.pagos.models import TransaccionPago, MetodoPagoConfig
from app.modules.p09_procesamiento_pagos.pagos.schemas import (
...
def confirmar_transaccion_pago(
    ...
    if orden.id_usuario:
        try:
            from app.modules.p07_venta_digital_fidelizacion.gamificacion.services import otorgar_puntos_por_compra
