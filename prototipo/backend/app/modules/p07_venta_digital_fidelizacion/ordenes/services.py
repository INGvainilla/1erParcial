...
from app.modules.p07_venta_digital_fidelizacion.ordenes.schemas import (
    OrdenCreateRequest, OrdenResponse, OrdenDetalleResponse
)
from app.modules.p07_venta_digital_fidelizacion.carrito.models import Carrito, CarritoItem
from app.modules.p07_venta_digital_fidelizacion.carrito.services import (
...
def crear_orden_desde_carrito(db: Session, id_usuario: int, orden_in: OrdenCreateRequest) -> OrdenResponse:
    ...
    try:
        ...
        if orden_in.codigo_cupon and orden_in.codigo_cupon.strip():
            try:
                from app.modules.p07_venta_digital_fidelizacion.gamificacion.services import validar_cupon_descuento, marcar_cupon_utilizado
